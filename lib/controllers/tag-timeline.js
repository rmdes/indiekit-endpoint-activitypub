...
import { getTimeline as getTimelineItems } from "../core/timeline.js";
import { getTagFollowState } from "../core/tags.js";
...
export function tagTimelineController(mountPath) {
  return async (request, response, next) => {
    try {
      ...
      const { following: isFollowed, globalFollow: isGloballyFollowed } =
        await getTagFollowState(
