...
import { getItem } from "../core/timeline.js";
  ...
  return async (request, response, next) => {
    try {
      ...
      if (replyTo) {
        ...
        // Try to find the post in our timeline first. getItem matches uid
        // (canonical AP URL) OR url (display URL) — the card passes the latter.
        replyContext = collections.ap_timeline
          ? await getItem(collections, replyTo)
          : null;
